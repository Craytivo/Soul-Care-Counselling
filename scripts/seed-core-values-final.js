...
const coreValuesPageData = {
  ...
  metaDescription:
    'Our core values: Mindfullness, Body care, Spiritual Care, Self-Love and Acceptance, and Community.',
  hero: {
    badge: 'Core Values',
...
async function seedCoreValuesPage() {
  ...
  try {
    ...
    if (existingPage) {
      ...
      await client.patch(existingPage._id).set(coreValuesPageData).commit()
