...
// Service page data based on the HTML content
const servicePagesData = [
  {
    ...
    metaDescription:
      'Trauma-informed, faith-centered individual counselling focused on rest, restoration, and emotional wellness. Private online sessions (50 minutes, $160).',
  ...
  },
  {
    ...
    metaDescription:
      'Affordable therapy option: 50-minute individual sessions at $80. Canada residents only. Limited spots, first-come first-served. Trauma-informed and faith-centered care.',
    ...
    sections: [
      ...
      },
      {
        ...
        description:
          'The Soul Care Affordability Program is a 6-month program where you can receive a maximum of 7 sessions at the affordability rate. After this, sessions increase to $100.00.\n\nThere are limited spots available for affordable therapy; services are provided on a first-come, first-served basis.',
        primaryButton: {
  ...
  },
  {
    ...
    metaDescription:
      'Low-Cost Therapy: Single Session Program (SSP). $20 per individual, up to 2 sessions. Choose a guided Soul Care Plan (Cohort 1) or targeted support for a specific concern (Cohort 2).',
        ...
        items: [
          {
            ...
            value:
              'Each session is offered at $20 per individual, with a maximum of 2 sessions allowed.',
          },
          {
            label: 'Student-Therapist Led',
            value:
  ...
  },
  {
    ...
    metaDescription:
      'Heal in community through faith-centered group therapy. Join the interest list for upcoming groups and be the first to know when dates are announced.',
    badge: 'Group Therapy',
        ...
        items: [
          {
            ...
            value: 'Facilitated by trained clinicians in a supportive, faith-informed environment.',
          },
          {
            label: 'Shared Growth',
            value: 'Normalize your experience and learn alongside others with similar journeys.',
          },
          {
            label: 'Practical Tools',
            value: 'Leave each session with simple practices for peace, renewal, and resilience.',
          },
        ],
      },
      {
        ...
        description:
          "Join the interest list and we'll email you when groups open for registration.",
        primaryButton: {
          text: 'Join the Interest List',
          url: '/contact',
          external: false,
...
async function seedServicePages() {
  console.log('🌱 Starting to seed service pages...')
  ...
  try {
    ...
    console.log('✅ Service pages seeded successfully!')
