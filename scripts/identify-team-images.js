...
function identifyTeamImages() {
  ...
  console.log('\nRecommendations:')
  console.log(
    '- Jessica Robinson-Grant (Clinical Director) is likely the first image: rs=w_365,h_365,cg_true,m.webp'
  )
  console.log(
    '- Upload this image to Sanity Studio and assign it to the About Page director section'
  )
  console.log('\nSteps:')
