...
export const metadata: Metadata = {
  ...
  description: 'Bio for Davene C.R. Harris — Associate Christian Therapist.',
}
...
const daveneData = {
  ...
  specialties: [
    "Women with childhood trauma (father wounds)",
    "Relationship & identity support",
    "Emotional health & resilience",
    "Faith-integrated therapeutic coaching",
    "Group facilitation & candid conversations"
  ],
  areasOfFocus: [
    "Father Wounds (healing & recovery)",
