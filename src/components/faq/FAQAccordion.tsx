...
export default function FAQAccordion({ question, answer, index, defaultOpen = false }: FAQAccordionProps) {
  ...
  return (
    <div className="rounded-2xl bg-white ring-1 ring-charcoal/5 overflow-hidden hover:ring-charcoal/10 shadow-elevation-1 hover:shadow-elevation-2 hover-lift transition-all duration-300">
      <button
